...
exports.CoingeckoPriceFinder = void 0;
const axios_1 = __importDefault(require("axios"));
const Coin_1 = require("../Coin");
class CoingeckoPriceFinder {
    constructor(pair) {
        this.prices = {};
    ...
    parseSymbolId(symbol) {
        switch (symbol) {
            ...
            case Coin_1.Coin.USDT: return "tether";
            case Coin_1.Coin.WBTC: return "bitcoin";
            default: return "ethereum";
        }
    }
}
exports.CoingeckoPriceFinder = CoingeckoPriceFinder;
//# sourceMappingURL=CoingeckoPriceFinder.js.map